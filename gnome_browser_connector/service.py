...
class Service(ApplicationHandler):
    def __init__(self, application: BaseGioApplication) -> None:
        ...
        self.add_simple_action(
            "create-notification", self.on_create_notification, "a{sv}"
        )
        self.add_simple_action(
            "on-notification-clicked", self.on_notification_clicked, "s"
        )
        self.add_simple_action(
            "on-notification-action", self.on_notification_action, "(si)"
        )
    ...
    def add_simple_action(
        self, name: str, callback: Callable[..., None], parameter_type: str
    ) -> None:
    ...
    def on_create_notification(
        self, source: GObject.Object, request: GLib.Variant
    ) -> None:
        ...
        notification.set_default_action_and_target(
            "app.on-notification-clicked", GLib.Variant.new_string(request["name"])
        )
    ...
    def on_notification_action(
        self, notification: GObject.Object, parameters: GLib.Variant
    ) -> None:
    ...
    def on_notification_clicked(
        self, notification: GObject.Object, notification_name: GLib.Variant
    ) -> None:
